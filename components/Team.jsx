            ...
            return (
              <div key={index} className="relative">
                <Image
                  src={team.image}
                  alt="/"
                  className="rounded-full object-cover h-60 lg:h-5/6 lg:w-3/6 mx-auto"
                />
                {/* Overlay */}
                <a href={team.url} target="blank">
                  <div className="flex justify-center w-full h-full lg:h-5/6 lg:w-3/6 rounded-full mx-auto items-center absolute top-0 left-0 right-0 bottom-0 hover:bg-black/50 group">
